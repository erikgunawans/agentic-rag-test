          ...
          {group.threads.map((thread) => (
            ...
            >
              ...
              <button
                ...
                className="opacity-0 group-hover:opacity-100 transition-opacity text-muted-foreground hover:text-destructive focus-ring flex items-center justify-center min-w-[36px] min-h-[36px]"
